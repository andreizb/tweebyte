Feature: Likes
  ...
  # Drives LikeService.likeReply's "reply does not exist" branch — the
  # IllegalArgumentException is mapped to 404 ("Reply does not exist.") by the
  # GlobalExceptionHandler.
  Scenario: Liking a non-existent reply returns 404
    Given user "rae" is registered with email "rae@example.com" and password "Sup3rS3cret!"
