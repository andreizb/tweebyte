...
// GET /media/{id} streams a resident 256 KiB blob in 64 KiB chunks at a throttled
// 6.25 MB/s, measuring the blocking-I/O memory/throughput shape. run.sh seeds the
// blob + passes --api-path /media/{id}; the default below is the same deterministic
// id (uuid5 "tweebyte-benchmark-media:file-download") so a standalone k6 run hits
// the seeded asset too.
...
const API_PATH = __ENV.API_PATH || '/media/d6ba0eab-a599-5d12-ba74-4be057e9c2ee';
