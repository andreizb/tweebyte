...
class FollowControllerTest {
        ...
        void getFollowing() throws Exception {
                ...
                mockMvc.perform(asyncDispatch(result))
                                .andExpect(status().isOk())
                                .andExpect(content().bytes(mockFollowing));
        ...
        void getFollowersIdentifiers() throws Exception {
                ...
                when(followService.getFollowedIdentifiers(userId))
                                .thenReturn(CompletableFuture.completedFuture(mockIdentifiers));
        ...
        void getFollowRequests() throws Exception {
                ...
                when(followService.getFollowRequests(userId))
                                .thenReturn(CompletableFuture.completedFuture(mockRequests));
        ...
        void follow() throws Exception {
                ...
                when(followService.follow(userId, followedId))
                                .thenReturn(CompletableFuture.completedFuture(mockFollowDto));

                MvcResult result = mockMvc.perform(post(BASE_URL + "/{userId}/{followedId}", userId, followedId)
        ...
        void updateFollowRequest() throws Exception {
                ...
                MvcResult result = mockMvc
                                .perform(put(BASE_URL + "/{userId}/{followRequestId}/{status}", userId, followRequestId,
                                                status)
                                                .contentType(MediaType.APPLICATION_JSON))
                                .andExpect(status().isNoContent())
                                .andReturn();
        ...
        void unfollow() throws Exception {
                ...
                MvcResult result = mockMvc.perform(delete(BASE_URL + "/{userId}/{followedId}", userId, followedId)
                                .contentType(MediaType.APPLICATION_JSON))
                                .andExpect(status().isNoContent())
                                .andReturn();
