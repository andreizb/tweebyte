...
class ReplyControllerTest {
        ...
        void createReply() throws Exception {
                ...
                MvcResult result = mockMvc.perform(post("/replies/{userId}", userId)
        ...
        void updateReply() throws Exception {
                ...
                when(replyService.updateReply(any(ReplyUpdateRequest.class)))
                                .thenReturn(CompletableFuture.completedFuture(null));

                MvcResult result = mockMvc.perform(put("/replies/{userId}/{replyId}", userId, replyId)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(new ObjectMapper().writeValueAsString(request)))
                                .andExpect(status().isOk())
                                .andExpect(request().asyncStarted())
        ...
        void deleteReply() throws Exception {
                ...
                MvcResult result = mockMvc.perform(delete("/replies/{userId}/{replyId}", userId, replyId))
                                .andExpect(status().isOk())
                                .andExpect(request().asyncStarted())
                                .andReturn();
