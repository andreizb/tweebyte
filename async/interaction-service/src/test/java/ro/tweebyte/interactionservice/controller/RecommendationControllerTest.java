...
class RecommendationControllerTest {
        ...
        public void findFollowRecommendations() throws Exception {
                ...
                when(recommendationService.recommendUsersToFollow(any(UUID.class), any()))
                                .thenReturn(CompletableFuture.completedFuture(expectedRecommendations));

                mockMvc.perform(get("/recommendations/{userId}/follow", userId))
        ...
        public void findHashtagRecommendations() throws Exception {
                ...
                when(recommendationService.computePopularHashtags())
                                .thenReturn(CompletableFuture.completedFuture(expectedHashtags));
        ...
        void findTweetSummaries() throws Exception {
                ...
                mockMvc.perform(asyncDispatch(
                                ...
                                .andExpect(jsonPath("$[0].tweet_id")
                                                .value(expectedSummaries.get(0).getTweetId().toString()))
                                .andExpect(jsonPath("$[1].tweet_id")
                                                .value(expectedSummaries.get(1).getTweetId().toString()));
