...
public class TweetInteractionsController {
	...
	public Flux<TweetInteractionsEntryDto> getTweetInteractions(@RequestBody List<UUID> tweetIds) {
		return this.tweetInteractionsService.getTweetInteractionsEntries(tweetIds).flatMapMany(Flux::fromIterable);
	}
