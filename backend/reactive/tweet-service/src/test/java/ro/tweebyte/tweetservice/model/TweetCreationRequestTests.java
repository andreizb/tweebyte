...
class TweetCreationRequestTests {
	...
	void testAllArgsConstructor() {
		...
		TweetCreationRequest request = new TweetCreationRequest(id, userId, content, mediaIds);
	...
	void testBuilder() {
		...
		TweetCreationRequest request = TweetCreationRequest.builder().id(id).userId(userId).content(content).build();
