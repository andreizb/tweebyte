...
/**
 * Wires the {@link ChatModel} bean the controllers / ChatClient consume. See the async
 * stack's AiConfiguration for the full contract.
 *
...
public class AiConfiguration {
	 ...
	 * fast instead of hanging the SSE Flux forever.
