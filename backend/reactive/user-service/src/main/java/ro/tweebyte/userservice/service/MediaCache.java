...
public class MediaCache {
	...
	public void put(MediaAssetEntity asset) {
		// MediaAssetEntity is a Persistable with a nullable id until persisted; callers
		// cache only saved assets, so the id is present.
		UUID id = Objects.requireNonNull(asset.getId(), "Cached media asset must have an id");
	 ...
	 * @param maxEntries the number of most-recently-used assets to retain
	 */
