...
public final class MediaConstants {
	 ...
	 * registrations default profile_picture_id to it and "remove my picture" swaps
	 * back to it, so the column is never user-facing NULL. image-upload mints ids via
