...
public class UserController {
	...
	@GetMapping("/{userId}")
	public Mono<UserDto> getUserProfile(@PathVariable("userId") UUID userId) {
		return this.userService.getUserProfile(userId);
	}

	@GetMapping("/summary/{userId}")
	public Mono<UserDto> getUserSummary(@PathVariable("userId") UUID userId) {
	...
	public Flux<UserDto> getUserSummaries(@RequestBody List<UUID> userIds) {
		return this.userService.getUserSummaries(userIds);
	}

	@GetMapping("/summary/name/{userName}")
	public Mono<UserDto> getUserSummaryByUserName(@PathVariable("userName") String userName) {
		return this.userService.getUserSummaryByUserName(userName);
	}

	@GetMapping("/search/{searchTerm}")
	public Flux<UserDto> searchUser(@PathVariable("searchTerm") String searchTerm,
	...
	public Mono<Void> updateUser(@PathVariable("userId") UUID userId,
