 ...
 * tokens, covering a backend that stops emitting mid-stream. The controller drains this
 * stream via {@code toStream()}, so the {@link java.util.concurrent.TimeoutException}
 * surfaces on the worker thread and ends the SSE emitter instead of parking forever.
 *
 * <p>
 ...
 * byte-for-byte unchanged. Mirrors the reactive-stack {@code TimeoutChatModel}.
 *
