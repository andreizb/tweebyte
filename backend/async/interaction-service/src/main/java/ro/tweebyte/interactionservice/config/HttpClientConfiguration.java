 ...
 *
 * <p>
 * Every downstream client ({@code UserClient}, {@code TweetClient}) injects the
 ...
 * tweet-service) at the per-route ceiling. The {@link #acquireTimeoutSeconds} mirrors
 * reactive's {@code pendingAcquireTimeout}: once a route's connections are all leased, the
 * {@code httpClientExecutor} thread parks for that long waiting for one to free.
 *
